...
// Para rellenar componentes seleccionables de dropdown hemos consultado al servicio para recuperar los autores y categorías buscando cuál es el que coincide con el ID enviado desde el listado
// De esta manera no cogemos los datos del listado, si no que aseguramos que los datos de autor y categoría vienen del servicio, siempre filtrando por su ID
