 ...
 * @author ccsw
 *
 * Se realizan las conversiones de cara al cliente, pasando de un Page<Author> (modelo entidad a un Page<AuthorDto> (modelo DTO) con la ayuda del beanMapper.
 */
...
public class AuthorController {
    ...
    @RequestMapping(path = "", method = RequestMethod.POST)  // camgia de GET a POST para poder enviarle los datos de la paginación para que Spring JPA pueda obrar
